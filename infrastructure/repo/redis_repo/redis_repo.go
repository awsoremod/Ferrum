...
// TODO поменять описание функций. с pointer на realm. на realmname
 ...
 */
func NewRedisDataManager(dataSourceCfg *config.DataSourceConfig, logger *logging.AppLogger) (*RedisDataManager, error) {
...
// Если существует такой ключ, значение будет перезаписано без ошибки
