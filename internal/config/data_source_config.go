...
import (
	...
	"github.com/wissance/Ferrum/internal/utils/validators"
	sf "github.com/wissance/stringFormatter"
)

type (
	DataSourceType       string
	DataSourceConnOption string
)
...
var SourceISEmpty error = errors.New("field source (path to file or conn str to db) is empty")
