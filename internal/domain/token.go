...
import (
	...
	"github.com/wissance/Ferrum/internal/utils/jsontools"
)
...
func NewAccessToken(commonData *JwtCommonInfo, userData *User) *AccessTokenData {
...
func NewRefreshToken(commonData *JwtCommonInfo) *TokenRefreshData {
